...
items = Table("items", metadata, autoload_with=engine)#esto sirve para cargar la tabla existente en la base de datos, lo que permite interactuar con ella sin necesidad de definir un modelo explícito en SQLAlchemy.
